    ...
    while True:
        ...
        if keypoints is not None:
            for k in keypoints:
                ...
                x_list.append(int(k.pt[0]))
                y_list.append(int(k.pt[1]))
        ...
        Optical_Center_x = 320
        Optical_Center_y = 246
        p = math.sqrt((Optical_Center_x*Optical_Center_x) + (Optical_Center_y*Optical_Center_y))
        b = 100
        ...
        print ("Differenace with the optical center: ", (Optical_Center_x-center_x),",",(Optical_Center_y-center_y))
        if center_x == 0:
            continue
        else:
            break
